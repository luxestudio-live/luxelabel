...
export default function AccountDashboard() {
  ...
  const orders = [
    { id: "ORD12345", date: "2025-11-10", status: "Shipped", total: "₹9,999.00" },
    { id: "ORD12344", date: "2025-10-28", status: "Delivered", total: "₹7,499.00" },
  ];
      ...
      <main className="flex-1 container mx-auto px-4 py-16 md:py-20 max-w-4xl">
        <div className="bg-white dark:bg-card p-8 rounded-xl shadow-lg border border-border/30 w-full mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
            ...
            {/* Wishlist card removed as requested */}
          </div>
          <div className="mb-10">
